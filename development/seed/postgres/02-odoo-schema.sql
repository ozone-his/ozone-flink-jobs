-- GENERATED by development/seed/generate-schemas.py from the odoo Flink table
-- definitions. Do not edit by hand; re-run the generator instead.
--
-- These are the odoo source tables the flattening pipelines read. Only the columns
-- the pipelines actually use are present, so this is not a full odoo schema.
