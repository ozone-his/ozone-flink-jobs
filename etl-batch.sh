...
java $JAVA_OPTS -jar etl-batch.jar --properties-file $PROPERTIES_FILE --sink-url $SINK_JDBC_URL --sink-username $SINK_JDBC_USERNAME --sink-password $SINK_JDBC_PASSWORD --source-url $SOURCE_JDBC_URL --source-username $SOURCE_JDBC_USERNAME --source-password $SOURCE_JDBC_PASSWORD