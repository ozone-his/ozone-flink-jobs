-- GENERATED by development/seed/generate-schemas.py from the openmrs Flink table
-- definitions. Do not edit by hand; re-run the generator instead.
--
-- These are the openmrs source tables the flattening pipelines read. Only the columns
-- the pipelines actually use are present, so this is not a full openmrs schema.
