...
/**
 * Flink Job Mekom ETL pipelines iy offers both Batch and Streaming options you can select the mode
 * in the job.properties file by setting job.streaming=true/false
 * <p>
...
public class StreamingETLJob {
	...
	public static void main(String[] args) throws Exception {
		...
		Map<String, String> openmrsConnectorOptions = Stream
		        .of(new String[][] { { "connector", "jdbc" }, { "url", parameter.get("openmrs.database.batch.url", "") },
		...
		Map<String, String> fileSystemConnectorOptions = Stream
		...
		if (streaming) {
			...
			openmrsConnectorOptions = Stream
		...
		String[] sourceTables = { "person", "person_name", "person_address", "patient", "patient_identifier",
		        ...
		        "encounter_diagnosis" };
		String[] sinkTables = { "visits", "patients", "concepts", "observations", "_orders", "encounters",
