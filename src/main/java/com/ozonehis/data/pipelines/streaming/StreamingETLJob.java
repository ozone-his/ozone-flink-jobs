...
import com.ozonehis.data.pipelines.shared.jobs.Job;
...
public class StreamingETLJob {
	...
	public static void main(String[] args) throws Exception {
		...
		tEnv.getConfig() // access high-level configuration
		        ...
		        .setString("table.exec.resource.default-parallelism",
		            parameter.get("table.exec.resource.default-parallelism", "6"));
