package com.ozonehis.data.pipelines.shared.dsl;

import com.ozonehis.data.pipelines.shared.dsl.sink.filesystem.AppointmentsFs;
import com.ozonehis.data.pipelines.shared.dsl.sink.filesystem.ConceptsFs;
import com.ozonehis.data.pipelines.shared.dsl.sink.filesystem.EncounterDiagnosesFs;
import com.ozonehis.data.pipelines.shared.dsl.sink.filesystem.EncountersFs;
import com.ozonehis.data.pipelines.shared.dsl.sink.filesystem.FlattenedConditionsFs;
import com.ozonehis.data.pipelines.shared.dsl.sink.filesystem.FlattenedOrdersFs;
import com.ozonehis.data.pipelines.shared.dsl.sink.filesystem.ObservationsFs;
import com.ozonehis.data.pipelines.shared.dsl.sink.filesystem.PatientProgramsFs;
import com.ozonehis.data.pipelines.shared.dsl.sink.filesystem.PatientsFs;
import com.ozonehis.data.pipelines.shared.dsl.sink.filesystem.VisitsFs;
import com.ozonehis.data.pipelines.shared.dsl.sink.jdbc.Appointments;
import com.ozonehis.data.pipelines.shared.dsl.sink.jdbc.Concepts;
import com.ozonehis.data.pipelines.shared.dsl.sink.jdbc.EncounterDiagnoses;
import com.ozonehis.data.pipelines.shared.dsl.sink.jdbc.Encounters;
import com.ozonehis.data.pipelines.shared.dsl.sink.jdbc.FlattenedConditions;
import com.ozonehis.data.pipelines.shared.dsl.sink.jdbc.FlattenedOrders;
import com.ozonehis.data.pipelines.shared.dsl.sink.jdbc.Observations;
import com.ozonehis.data.pipelines.shared.dsl.sink.jdbc.PatientPrograms;
import com.ozonehis.data.pipelines.shared.dsl.sink.jdbc.Patients;
import com.ozonehis.data.pipelines.shared.dsl.sink.jdbc.Visits;
import com.ozonehis.data.pipelines.shared.dsl.source.*;
...
/**
 * The class provides a factory method for getting Source/Sink Dynamic Table DSL for use in
 * {@link StreamingETLJob ETLJob.class}
 */
